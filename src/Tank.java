...
// 真是牛皮
public class Tank {
	public static  int speedX = 6, speedY =6; // 静态全局变量速度---嘿嘿嘿--可以作为扩张来设置级别，速度快的话比较难
	public static int count = 0;
	public static final int width = 35, length = 35; // 坦克的全局大小，具有不可改变性是的
...
// i'm master,change file
	...
	void move() {
		...
		if (x < 0)
			x = 0;
		if (y < 40)      //防止走出规定区域,enen是的
			y = 40;
		if (x + Tank.width > TankClient.Fram_width)  //删除
